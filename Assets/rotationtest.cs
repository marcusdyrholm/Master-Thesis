...
public class rotationtest : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 playerVector = cube1.transform.position - Player.instance.transform.position;
        cube1.transform.RotateAround(cube1.transform.position, playerVector, xAngle);
